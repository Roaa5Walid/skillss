                              ...
                              itemBuilder: (BuildContext context, int i) {
                                return  Column(
                                  children: [
                                    ...
                                    textfielBox(companyNameController, "اسم المؤسسة"),
                                    textfielBox(companyLocationController, "موقع المؤسسة"),
                                    textfielBox(companyCategoryController, "التخصص"),
                                    textfielBox(companyEmailController, "الايميل"),
                                    textfielBox(companyDescriptionController, "وصف المؤسسة"),
                                    textfielBox(companyNeedsController, "احتياجات المؤسسة"),
                                    //image
                                    Padding(
